...
# charge of any vehicle is seating capacity * 100. If Vehicle is Bus instance, we need to add an
# extra 10% on full fare as a maintenance charge. So total fare for
...
# print("Total bus fareis :",School_bus.fare())
#
...
#     pass
#
# School_bus = Bus("School Vovo", 12, 50)
